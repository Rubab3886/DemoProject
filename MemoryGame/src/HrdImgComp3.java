...
public class HrdImgComp3 implements ActionListener {
	JFrame jf;
	...
	HrdImgComp3(){
		...
		public void actionPerformed(ActionEvent e) {
			...
			String array[]={"pin","scissor","scale","clock","pen","compass","notebook","lamp","highlighter"
			,"book","ballpoint","telephone","envelop"};
