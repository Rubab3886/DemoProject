...
public class MedImgComp1 implements ActionListener {
	JFrame jf;
	...
	MedImgComp1(){
		...
		t3=new JTextField();
		t=new JTextField();
		l=new JLabel("ENTER THE OBJECTS YOU OFSERVED ");
		...
		public void actionPerformed(ActionEvent e) {
			...
			String array[]={"pizza","email","cake","hanger","clock","wheel","ball","balloon","watermelon","plate","egg","button"};
