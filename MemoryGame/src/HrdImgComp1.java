...
public class HrdImgComp1 implements ActionListener {
	JFrame jf;
	...
	HrdImgComp1(){
		...
		public void actionPerformed(ActionEvent e) {
			...
			String array[]={"fan","telephone","endtable","blinds","picture","television","curtains","fireplace","Grandfatherclock"
			,"remote","floorlamp","table","carpet","vase","teaset","cushion","wingchair"};
